                    ...
                    <div className="w-full max-w-md">
                        <div className="bg-white shadow-lg rounded-lg">
                            <div className="bg-gray-100 p-6 rounded-t-lg">
                                <h1 className="text-2xl font-bold">비밀번호를 입력해주세요.</h1>
                                <p className="mt-2 text-gray-600">비밀번호가 있습니다. 비밀번호를 입력해주세요.</p>
                            </div>
                            <div className="p-6">
                                <div id="pwForm">
                                    
                                    <div className="mb-4">
                                        <label htmlFor="inputnumber" className="block text-sm font-medium text-gray-700">
                                            비밀번호
                                        </label>
                                        <input
                                            type="password"
